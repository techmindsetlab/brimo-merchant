...
export const stepMerchant = [
    { title: "Download BRI Merchant", description: "Unduh aplikasinya sekarang dan klik “Daftar” atau “Register” untuk mulai daftar", image: "/images/merchant_phone.svg", icon: "/icons/download.svg" },
    { title: "Lengkapi Data Diri dan Usaha Anda", description: "Isi data diri dan informasi usaha Anda. Tinggal ikuti langkah-langkahnya", image: "/images/form_phone.svg", icon: "/icons/clip.svg" },
    { title: "QRIS Siap Dipakai", description: "Setelah data Anda selesai diverifikasi, QRIS langsung bisa dipakai buat terima pembayaran dari pelanggan.", image: "/images/qris.svg", icon: "/icons/dashboard.svg" },
]
