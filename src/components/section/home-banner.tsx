    ...
    <div className="flex bg-pattern">
      <div className="w-[50%] flex flex-col justify-center">
        <h1 className="font-brineue-bold  text-[4rem] leading-[4rem]  text-secondary-blue">
          Dagangan <span className="font-blanquotey">lancar</span> <br />
          transaksi{" "}
          <span className="font-blanquotey text-accent-orange">
            praktis
          </span>{" "}
          <br />
          cairnya <span className="font-blanquotey">gampang</span>
        </h1>
        <p className="text-primary-blue mt-4">Gabung BRImerchant sekarang!</p>
        <Button
          buttonText={"Daftar Sekarang"}
          className={
            "rounded-3xl w-fit font-jakarta mt-8 hidden md:block text-lg px-6 py-2 text-primary-white text-center bg-accent-orange"
          }
        />
      </div>
