...
const HomeBenefit = () => {
  ...
  const filter = ["EDC + QRIS Dinamis", "QRIS Statis"];
  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center">
        ...
        <Paragraph
          fontUbuntu
          className="text-3xl text-secondary-blue mt-8 font-bold"
        >
          {activeFilter === 0
      ...
      <div className="flex justify-center">
        <Button
          ...
          className={
            "rounded-3xl w-fit font-jakarta mt-8 hidden md:block text-md px-6 py-2 text-primary-white text-center bg-accent-orange"
          }
        />
      </div>
    </div>
